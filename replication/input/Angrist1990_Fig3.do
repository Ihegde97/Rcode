 ...
 cap log close
 * log using log using "Z:\Angrist Work\Vets_1990_Archive\Log Files\Angrist1990_Fig3.log", replace

*************************************************
* PROGRAM: Angrist1990_Fig3
* PROGRAMMER: Simone Schaner (sschaner@mit.edu)
* PURPOSE: Replicates Figure 3 from Angrist (1990)
...
cd "H:\Angrist Work\Web Papers\Angrist_1990\STATA Data"
